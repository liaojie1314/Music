...
import com.example.music.music.netease.Playlist
import com.example.music.music.netease.PlaylistUtil
...
class PlaylistActivity : AppCompatActivity() {
    ...
    private fun initPlaylist(source: Int, id: Long) {
        when (source) {
            ...
            SOURCE_example -> {
                val url = "https://moriafly.xyz/example-music/json/music.json"
